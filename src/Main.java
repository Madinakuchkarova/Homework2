public class Main {
    public static void main(String[] args) {
        System.out.println("Home work2! ЗАДАЧА 1");
        var dog = 8;
        ...
        System.out.println("РАЗНИЦА В ВЕСЕ БОКСЕРОВ " + (boxerSecond - boxerFirst));
        System.out.println("ЗАДАНИЕ 7");
        System.out.println("1 СПОСОБ РАЗНИЦА В ВЕСЕ БОКСЕРОВ " + (boxerSecond - boxerFirst));
        System.out.println("2 СПОСОБ РАЗНИЦА В ВЕСЕ БОКСЕРОВ " + (boxerSecond % boxerFirst));
